...
-- 1. 用户管理表 (user_management) - 进一步增加username字段长度
CREATE TABLE users (
...
CREATE TABLE boards (
    ...
    name VARCHAR(200) NOT NULL UNIQUE COMMENT '板块名称',
...
CREATE TABLE articles (
    ...
    author VARCHAR(200) NOT NULL COMMENT '作者名称',
...
CREATE TABLE system_config (
    ...
    updated_by VARCHAR(200) DEFAULT 'system' COMMENT '更新者',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
