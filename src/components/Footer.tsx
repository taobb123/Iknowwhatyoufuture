      ...
      <div className="max-w-7xl mx-auto py-8 px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-xl font-bold text-yellow-400 mb-4">Iknowwhatyoufuture</h3>
          ...
          {/* 法律信息 */}
          <div>
            <h4 className="text-lg font-semibold text-yellow-400 mb-4">法律信息</h4>
            <ul className="space-y-2">
              <li><Link to="/privacy" className="text-gray-400 hover:text-white transition-colors">隐私政策</Link></li>
              <li><Link to="/terms" className="text-gray-400 hover:text-white transition-colors">服务条款</Link></li>
